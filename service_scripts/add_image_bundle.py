...
filepath = "files/tcpreplay.swix"
#image = clnt.api.add_image(filepath)
#get_image = clnt.api.get_images()

imagebundle = clnt.api.save_image_bundle("tcpreplay", ["tcpreplay"], certified=False)
